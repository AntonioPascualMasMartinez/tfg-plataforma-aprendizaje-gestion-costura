...
export class Sidebar {
  ...
  // Definición de la navegación con SVGs inyectados para mantener el HTML limpio
  navItems = [
    {
      label: 'Inicio',
      path: '/home/inicio', // Actualizado
    ...
    {
      label: 'Proyectos',
      path: '/home/proyectos', // Actualizado
    ...
    {
      label: 'Tutoriales',
      path: '/home/tutoriales', // Actualizado
